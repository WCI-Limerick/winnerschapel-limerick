...
::
  ...
  <div class="mx-auto mt-20 grid max-w-screen-lg grid-cols-1 gap-x-8 gap-y-12 text-center sm:text-left md:grid-cols-3">
        <div class="backdrop-blur-lg relative mb-3 rounded-3xl border bg-white/70 px-12 py-10 text-left shadow xl:px-12">
          ...
          <p class="relative mt-5 text-center font-bold text-gray-600">Sunday: Covenant Day of All Round Rest <br> Venue: Church Auditorium.</p>
        </div>
...
::card-group{:cols="3"}
  ::card
  ---
  img: /WhatsApp Image 2026-05-22 at 13.19.05.jpeg
  ---
  #title
  Covenant Day of All Round Rest

  #content
  Join us this Sunday 24th May. 2026 - 11.30am
  ::

...
<div class="mx-auto max-w-full px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
    <p class="mx-auto -mt-4 max-w-2xl text-fluid tracking-tight text-slate-700 sm:mt-6">Welcome to the
        <span class="border-b border-dotted border-sky-600">Home of Signs and Wonders</span>
    </p>

  <h1 class="mx-auto max-w-full text-fluid sm:text-3xl lg:text-5xl font-bold tracking-tight text-slate-900">
  ...
  <p class="mx-auto mt-9 max-w-2xl text-fluid tracking-tight text-slate-700 sm:mt-6">

        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div class="relative">
                <div class="lg:w-2/3">
                    ...
                    <h1 class="mt-6 text-4xl font-normal text-white sm:mt-10 sm:text-5xl lg:text-6xl xl:text-8xl"><span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-purple-500">Winners Chapel</span>International Limerick</h1>
                ...
                </div><div class="mt-8 md:absolute md:mt-0 md:top-32 lg:top-0 md:right-[-7rem]">

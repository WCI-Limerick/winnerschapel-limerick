...
<!-- Hero -->
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="h-120 md:h-[80dvh] flex flex-col bg-[url('https://i.postimg.cc/fWYdXT8L/20250705-193525.jpg')] bg-cover bg-center bg-no-repeat rounded-2xl shadow-2xl saturate-200 -m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">

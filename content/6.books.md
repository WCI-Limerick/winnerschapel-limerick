...
<div class="text-center p-10">
    ...
    <h1 class="text-3xl">November 2025</h1>
</div>
...
<div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
            <img src="/UnderstandingthePowerofPraise__09742.webp"
                    alt="Product" class="h-80 w-72 object-cover rounded-t-xl" />
            <div class="px-4 py-3 w-72">
                <span class="text-gray-400 mr-3 uppercase text-xs">Dr David Oyedepo</span>
                <p class="text-lg font-bold text-black truncate block capitalize">Understanding the Power of Praise</p>

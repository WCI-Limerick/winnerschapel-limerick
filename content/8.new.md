...
::button-link{left-icon="lucide:flower" variant="ghost" href="https://faithtabernacle.org.ng/2025/WHYAREYOUASKINGUSTOCOMETOWINNER.pdf?v=2.4" blank}
  Why Are You Asking Us To Come To Winners?
::
::button-link{left-icon="lucide:heart" variant="ghost" href="https://faithtabernacle.org.ng/2025/GODISHEREATWINNERSCONFIRMINGHISWORDAGAINANDAGAIN.pdf?v=2.4" blank}
  God Is Here At Winners.
::
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="mt-5 lg:mt-16 grid lg:grid-cols-3 gap-8 lg:gap-12">
    <div class="sm:text-center">
        ...
        You are free to call any of the numbers listed here to speak to someone or to have someone agree with you in prayer: +353872685434; +353877991429 <br>
      </p>
      </div>
    <!-- End Col -->

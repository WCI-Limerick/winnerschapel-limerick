...
]'} autoplay interval=4000 loop showDots showArrows::


::carousel{images="/science.png|/og-nuxt.png|/og-nuxt-seo.png"} autoplay interval=4000 loop showDots showArrows::

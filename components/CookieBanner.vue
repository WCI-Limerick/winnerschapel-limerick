<template>
  <div
    v-if="visible"
    id="cookie-banner"
    class="fixed bottom-0 right-0 mb-4 mr-4 w-72 z-50"
  >
      ...
      <div class="flex items-center justify-between mb-2">
        <div class="flex items-center">
          <img
            ...
            class="h-6 w-6 mr-2"
          />
          <span class="text-gray-700 dark:text-white font-bold text-sm">
            Cookie Policy
          </span>
        </div>
        <button
...
onMounted(() => {
  if (typeof localStorage !== 'undefined') {
    visible.value = localStorage.getItem('cookieAccepted') !== 'true'
  }
})
